...
df = pd.read_csv('C:\\HCA\\heart-good.csv')  # Replace 'your_dataset.csv' with your actual dataset file path
df_long= pd.read_csv('C:\\HCA\\New_clean.csv')
df2= pd.read_csv('C:\HCA\map2_hosp.csv')
